...
def myblock(tw, args):
    ...
    import os    
    from gi.require_version("Gst", "1.0")
    ...
    class Grecord:
        ...
        def _create_audiobin(self):
            ...
            srccaps = Gst.Caps.from_string(
                "audio/x-raw, rate=16000, channels=1, depth=16")
            ...
            sink.set_property("uri", "file://" + self.capture_file)
...
! oggmux name=audioOggmux ! filesink name=audioFilesink'
            ...
            audioFilesink.set_property("uri", "file://" + self.save_file)
